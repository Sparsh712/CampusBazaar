...
export default function ListingCard({ listing, onBuy, accountAddress, wishlist, onToggleWishlist, onChat }) {
    ...
    return (
        <div style={{ background: "#111827", border: "1px solid #1f2937", borderRadius: 16, padding: 20, display: "flex", flexDirection: "column", gap: 12, transition: "transform .2s, border-color .2s, box-shadow .2s", cursor: "default", animation: "fadeIn .4s ease" }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                ...
                <span style={{ fontSize: 11, color: "#4b5563", fontFamily: "'DM Mono', monospace" }}>by {truncate(listing.seller)}</span>
            </div>
            {/* Price + Actions */}
